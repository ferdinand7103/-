    ...
    var body: some View {
        ZStack {
            if viewModel.quizView == "Quiz" {
                QuizTop(viewModel: viewModel, homeViewModel: homeViewModel, text: viewModel.currentStory.quiz1.text)
                ...
                QuizTop(viewModel: viewModel, homeViewModel: homeViewModel, text: viewModel.currentStory.quiz1.happyFlow)
                ...
                QuizTop(viewModel: viewModel, homeViewModel: homeViewModel, text: viewModel.currentStory.quiz1.negativeFlow)
...
#Preview {
    QuizPage(viewModel: StoryViewModel(), homeViewModel: HomeViewModel())
}
